...
const Footer = () => {
  return (
    <footer className="bg-slate-700 z-20 bottom-0 w-100 ">
    <div className="mx-auto max-w-7xl py-8 h-4 px-4 sm:px-6 mt-1 md:flex md:items-center md:justify-between lg:px-8">
